...
export class TableSectionComponent implements OnInit {
  ...
  ngOnInit() {
    this.queryParamsSubscription = this.route.queryParams.subscribe((params: any) => {
      ...
      if (params['subcategory_id']) {
        ...
        this.paramsUrl = `/admin/product/get?subcategory_id=${encodeURIComponent(this?.subcategory_id)}`
        console.log("this.category_id", this.subcategory_id);
      }
      else {
        this.url = '/admin/product/get'
      }
    })
    this.getCategory()
    this.getProductlist()
  ...
  getCategory() {
    this.global.getAuthenticateData(this.global.basepath + '/admin/category/get').pipe(takeUntil(this.unsubscribe$)).subscribe((res: any) => {
  ...
  getSubCategory(category_id: any) {
    ...
    this.global.getAuthenticateData(this.global.basepath + `/admin/subcategory/get?category_id=${encodeURIComponent(category_id)}`).pipe(takeUntil(this.unsubscribe$)).subscribe((res: any) => {
  ...
  addProductCategory() {
    ...
    formData.append('sub_category_id', this.addProductCategoryForm.get('subcategory')?.value!)
    formData.append('name', this.addProductCategoryForm.get('productName')?.value!)
    formData.append('price', this.addProductCategoryForm.get('ProductPrice')?.value!)
    formData.append('discounted_price', this.addProductCategoryForm.get('discountPrice')?.value!)
    formData.append('available_quantity', this.addProductCategoryForm.get('productQuantity')?.value!)
    formData.append('description', this.addProductCategoryForm.get('productDescription')?.value!)
    formData.append('title', this.addProductCategoryForm.get('productTitle')?.value!)


    // let data = {
    //   images : JSON.stringify(this.images),
    //   admin_id : localStorage.getItem("id")!,
    //   category_id : this.addProductCategoryForm.get('category')?.value!,
    //   sub_category_id :this.addProductCategoryForm.get('subcategory')?.value!,
    //   name : this.addProductCategoryForm.get('productName')?.value!,
    //   price : this.addProductCategoryForm.get('ProductPrice')?.value!,
    //   discounted_price : this.addProductCategoryForm.get('discountPrice')?.value!,
    //   available_quantity : this.addProductCategoryForm.get('productQuantity')?.value!,
    //   description : this.addProductCategoryForm.get('productDescription')?.value!,
    //   title : this.addProductCategoryForm.get('productTitle')?.value!
    // }
    // console.log("formData", data);

    this.global.postAuthenticateData(this.global.basepath + '/admin/product/create', formData).pipe(takeUntil(this.unsubscribe$)).subscribe(
      (res: any) => {
        this.getProductlist()
  ...
  UpdateProductCategory() {
    let data = {
      ...
      title: this.UpdateProductCategoryForm.get('productTitle')?.value!,
      id: this.product_id
    }
  ...
  patchValue(data: any) {
    ...
    this.UpdateProductCategoryForm?.controls['productTitle'].setValue(data.title)
